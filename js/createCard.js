...
function createNormalCard(card){
  ...
  if (card.attribute) {whichAttribute(`cardSubTitle_${card.id}`, card.attribute, card)} else { document.getElementById(`cardSets_${card.id}`).innerHTML = `No prints for this card in TCG yet. ` }
